    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo bu().'/site/index'?>"><img title="logo" src="<?php echo bu(); ?>/img/pizza-fan110.png"> </a>
               <a class="navbar-brand" href="<?php echo bu().'/site/index'?>">Mail List administration</a>
            </div>
